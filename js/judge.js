...
{
	//[24,15,25,20,35,102]
	document.getElementById("pearlText").value = 24;
	document.getElementById("teaText").value = 15;
	document.getElementById("milkText").value = 25;
	document.getElementById("powderText").value = 20;
	document.getElementById("sugarText").value = 35;
	document.getElementById("iceText").value = 102;
}
